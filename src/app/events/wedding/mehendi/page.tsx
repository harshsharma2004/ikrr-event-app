      ...
      <section className="relative min-h-[85vh] flex items-center justify-center text-center px-6 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto animate-fade-in-up pt-24">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-extrabold tracking-tighter mb-6 drop-shadow-2xl text-white">
            THE <span className="text-brand-gold">MEHENDI</span>
          </h1>

          <p className="text-2xl sm:text-4xl text-gray-100 mb-10 italic font-light tracking-wide drop-shadow-lg">
            "Henna, Joy & Togetherness"
          </p>

          <p className="text-lg sm:text-xl text-gray-200 mb-12 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-md">
            A vibrant celebration of color, music, and feminine joy. We craft unforgettable mehendi ceremonies filled with laughter, dancing, and beautiful traditions.
          </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left text-[#4B3C55] order-2 md:order-1">
            ...
            <h2 className="text-4xl sm:text-6xl font-bold mb-8 text-[#4B3C55] tracking-tight">
              Colors of <span className="text-brand-gold">Tradition</span>
            </h2>
            <p className="text-xl mb-6 leading-relaxed font-medium">
              The mehendi ceremony is a joyful celebration of henna, music, and sisterhood. It's a beautiful pre-wedding ritual where the bride and her close friends gather to apply intricate henna designs.
            </p>
            <p className="mb-10 leading-relaxed text-[#4B3C55]/80 text-lg">
              From professional mehendi artists to vibrant decorations and energetic entertainment, we curate every moment to make this celebration truly special and memorable for all attendees.
            </p>
          ...
          <div className="relative group order-1 md:order-2">
            ...
            <Image src="/mehendi featured.jpg" alt="Mehendi Celebration" width={600} height={600} className="relative rounded-2xl shadow-2xl w-full object-cover transform group-hover:-translate-y-2 transition-transform duration-500 border-4 border-white/30" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative z-10">
        <div className="container mx-auto px-6 max-w-6xl">
          <h2 className="text-4xl sm:text-5xl font-bold mb-12 text-center text-[#4B3C55]">
            Mehendi <span className="text-brand-gold">Highlights</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Henna Art</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Professional mehendi artists, intricate designs, and premium quality henna for all guests.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Live Entertainment</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                DJs, live singers, or traditional musicians to keep the energy high throughout the celebration.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Decor & Ambiance</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Floral decorations, traditional seating, and customized setups tailored to your vision.
              </p>
            </div>
          </div>
