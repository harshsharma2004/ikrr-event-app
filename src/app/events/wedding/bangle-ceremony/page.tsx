...
export default function BangleCeremonyPage() {
  return (
    <main className="bg-[#C6BACE] min-h-screen">
      <section className="relative min-h-[85vh] flex items-center justify-center text-center px-6 py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/bangle ceremony background.jpg"
            alt="Bangle Ceremony Background"
            fill 
        ...
        <div className="relative z-10 max-w-5xl mx-auto animate-fade-in-up pt-24">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-extrabold tracking-tighter mb-6 drop-shadow-2xl text-white">
            THE <span className="text-brand-gold">BANGLE CEREMONY</span>
          </h1>

          <p className="text-2xl sm:text-4xl text-gray-100 mb-10 italic font-light tracking-wide drop-shadow-lg">
            "Colors of Joy & Auspiciousness"
          </p>

          <p className="text-lg sm:text-xl text-gray-200 mb-12 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-md">
            A beautiful ritual symbolizing joy and prosperity. We arrange elegant bangle ceremonies with traditional customs and modern elegance.
          </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left text-[#4B3C55] order-2 md:order-1">
            ...
            <h2 className="text-4xl sm:text-6xl font-bold mb-8 text-[#4B3C55] tracking-tight">
              Colorful <span className="text-brand-gold">Beginnings</span>
            </h2>
            <p className="text-xl mb-6 leading-relaxed font-medium">
              The bangle ceremony is a cherished tradition symbolizing joy and prosperity. As mothers and sisters lovingly adorn the bride with vibrant bangles, it marks the beginning of a beautiful journey ahead.
            </p>
            <p className="mb-10 leading-relaxed text-[#4B3C55]/80 text-lg">
              We create an elegant and traditional atmosphere with premium bangle selections, flower-adorned settings, and heartfelt rituals that honor this sacred moment and bring families together in celebration.
            </p>
          ...
          <div className="relative group order-1 md:order-2">
            ...
            <Image src="/bangle ceremony featured.jpg" alt="Bangle Ceremony" width={600} height={600} className="relative rounded-2xl shadow-2xl w-full object-cover transform group-hover:-translate-y-2 transition-transform duration-500 border-4 border-white/30" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Premium Bangles</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Curated selection of colorful and traditional bangles for the bride and family members.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Floral Decor</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Beautiful floral arrangements and traditional decorative elements for the ceremony.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4B3C55]">Celebration Setup</h3>
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Complete arrangement of seating, refreshments, and traditional rituals.
              </p>
            </div>
          </div>
