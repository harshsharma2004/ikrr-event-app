// Create this folder path: /src/app/events/fresher
// Create this file: /src/app/events/fresher/page.tsx
    ...
    <main className="bg-[#C6BACE] min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center text-center px-6 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          {/* Replace with your actual Fresher.jpg later */}
          <Image
            src="/fresher background.jpg"
            alt="Fresher Party Background"
            fill 
        ...
        <div className="relative z-10 max-w-5xl mx-auto animate-fade-in-up pt-24">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-extrabold tracking-tighter mb-6 drop-shadow-2xl text-white">
            NEW <span className="text-brand-gold">BEGINNINGS</span>
          </h1>
          ...
          <p className="text-lg sm:text-xl text-gray-200 mb-12 max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-md">
            A warm, vibrant welcome for the new faces. We create an engaging atmosphere that breaks the ice, fosters connections, and celebrates the start of an exciting new journey.
          </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left text-[#4B3C55] order-2 md:order-1">
            ...
            <h2 className="text-4xl sm:text-6xl font-bold mb-8 text-[#4B3C55] tracking-tight">
              Hello, <span className="text-brand-gold">Future</span>
            </h2>

            <p className="text-xl mb-6 leading-relaxed font-medium">
              Stepping into a new environment can be daunting. Our fresher parties are designed to make everyone feel at home instantly. We focus on inclusivity, fun interaction, and creating a relaxed vibe.
            </p>

            <p className="mb-10 leading-relaxed text-[#4B3C55]/80 text-lg">
              From college orientations to corporate onboarding socials, we handle the music, the menu, and the mood. Let's turn strangers into friends and colleagues into teammates.
            </p>
          ...
          <div className="relative group order-1 md:order-2">
            ...
            <Image 
              src="/group bonding moment.jpg"
              alt="Group bonding moment" 
              width={600}
              height={600}
      ...
      <section className="py-24 relative overflow-hidden bg-white/20 backdrop-blur-sm border-y border-[#4B3C55]/10">
        ...
        <div className="container mx-auto px-6 max-w-7xl text-center relative z-10">
          ...
          <p className="text-xl text-[#4B3C55]/80 mb-20 max-w-2xl mx-auto">
            Activities designed to connect and celebrate.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                A friendly stage for open mics, introduction rounds, or lighthearted talent shows to let personalities shine.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                Buffet-style finger foods, pizza stations, or food trucks that encourage mingling while eating.
              </p>
            </div>
            ...
            <div className="group bg-[#C6BACE] p-10 rounded-3xl shadow-xl border border-[#4B3C55]/10 hover:border-brand-gold/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-[#4B3C55]/80 leading-relaxed text-lg">
                An energetic playlist with current hits to get everyone on the dance floor and celebrating together.
              </p>
            </div>
